...
namespace NodeApp.Migrations.MessengerDb
{
    ...
    [Migration("20191106112849_AddTokenLastActivity")]
    partial class AddTokenLastActivity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.Administrator", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.ChangeUserNodeOperation", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.ChannelIdentificator", b =>
                {
                    b.Property<long>("ChannelId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.ChatIdentificator", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.Contact", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.ContactGroup", b =>
                {
                    b.Property<Guid>("ContactId");
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.EditedMessage", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.EditedMessageAttachment", b =>
                {
                    b.Property<long>("RecordId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.FileIdentificator", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.Group", b =>
                {
                    b.Property<Guid>("GroupId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.NodeKeys", b =>
                {
                    b.Property<long>("NodeId");
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.Poll", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.PollOption", b =>
                {
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.PollOptionVote", b =>
                {
                    b.Property<byte>("OptionId");
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.UserFavorite", b =>
                {
                    b.Property<long>("RecordId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.UserIdentificator", b =>
                {
                    b.Property<long>("UserId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.Contact", b =>
                {
                    b.HasOne("NodeApp.MessengerDb.Entities.User", "ContactUser")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.ContactGroup", b =>
                {
                    b.HasOne("NodeApp.MessengerDb.Entities.Contact", "Contact")
                        .WithMany("ContactGroups")
                        .HasForeignKey("ContactId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NodeApp.MessengerDb.Entities.Group", "Group")
                        .WithMany("ContactGroups")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.EditedMessage", b =>
                {
                    b.HasOne("NodeApp.MessengerDb.Entities.Message", "ActualMessage")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.EditedMessageAttachment", b =>
                {
                    b.HasOne("NodeApp.MessengerDb.Entities.Attachment", "ActualAttachment")
                        .WithMany("EditedMessageAttachments")
                        .HasForeignKey("ActualAttachmentId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("NodeApp.MessengerDb.Entities.EditedMessage", "Message")
                        .WithMany("Attachments")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.PollOption", b =>
                {
                    b.HasOne("NodeApp.MessengerDb.Entities.Poll", "Poll")
                        .WithMany("Options")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.PollOptionVote", b =>
                {
                    ...
                    b.HasOne("NodeApp.MessengerDb.Entities.PollOption", "PollOption")
            ...
            modelBuilder.Entity("NodeApp.MessengerDb.Entities.UserFavorite", b =>
                {
                    ...
                    b.HasOne("NodeApp.MessengerDb.Entities.Contact", "Contact")
                        ...
                        .HasForeignKey("NodeApp.MessengerDb.Entities.UserFavorite", "ContactId");

                    b.HasOne("NodeApp.MessengerDb.Entities.User")
                        .WithMany("Favorires")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
